...
public class MatchService {
    ...
    public void updatePlayerStats(String playerId, String playerName, int runsScored, int wicketsTaken) {
        try {
            // Create PlayerStats object
            PlayerStats stats = new PlayerStats(playerId, playerName, runsScored, wicketsTaken);
